...
class Calibration(object):
    ...
    def __init__(self, calib_filepath, from_video=False):
        ...
        self.V2C = calibs["Tr_velo_to_cam_3"]
        self.V2C = np.reshape(self.V2C[:12], [3, 4])
...
def draw_box3d_on_top(
    ...
    for n in range(num):
        ...
        if is_gt:
            ...
            startx = 85
        cv2.line(img, (v0, u0), (v1, u1), color, thickness, cv2.LINE_AA)
        cv2.line(img, (v1, u1), (v2, u2), color, thickness, cv2.LINE_AA)
        cv2.line(img, (v2, u2), (v3, u3), color, thickness, cv2.LINE_AA)
        cv2.line(img, (v3, u3), (v0, u0), color, thickness, cv2.LINE_AA)
